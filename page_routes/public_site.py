...
/     /     >---- البوابة القديمة: صفحات ثابتة تُقدَّم من static/public بنفس العناوين الأصلية.
"""
import os
...
# /     /     >---- صفحات اندمجت في البوابة الموحدة فنُحِلت لإعادة توجيه
LEGACY_REDIRECTS = {
...
# /     /     >---- صفحات الموقع القديم مع إعادة توجيه المندمج منها
